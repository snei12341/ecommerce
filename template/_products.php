        ...
        <div class="row">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    ...
                    <div class="col">
                        ...
                        if (in_array($item['item_id'], $Cart->getCartId($product->getData('cart')) ?? [])){
                            echo '<button type="submit" disabled class="btn btn-success font-size-16 form-control">No carrinho</button>';
                        }else{
                            echo '<button type="submit" name="top_sale_submit" class="btn btn-warning font-size-16 form-control">Adicionar ao carrinho</button>';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6 py-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="#" class="px-2 font-rale font-size-14">20,534 avaliações | 1000+ avaliações</a>
                </div>
                <hr class="m-0">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        ...
                        <td class="font-size-20 text-danger">$<span><?php echo $item['item_price'] ?? 0; ?></span><small
                                class="text-dark font-size-12">&nbsp;&nbsp;Taxas Inclusas</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Você salvou:</td>
                ...
                <div id="policy">
                    <div class="d-flex">
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">10 Dias <br> Troca</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-truck  border p-3 rounded-pill"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">Allan Reis <br>Entrega</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                                <span class="fas fa-check-double border p-3 rounded-pill"></span>
                            </div>
                            <a href="#" class="font-rale font-size-12">1 Ano <br>Garantia</a>
                        </div>
                    </div>
                </div>
                <!--    !policy -->
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    <small>Entrega para : Ago 29 - Set 1</small>
                    <small>Vendido por <a href="#">Electronics </a>(4.5 de 5 | 18,198 avaliações)</small>
                    <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Entregue para -
                        424201</small>
                </div>
                <!-- !order-details -->
                ...
                <!-- size -->
                <div class="size my-3">
                    <h6 class="font-baloo">Tamanho :</h6>
            ...
            <div class="col-12">
                <h6 class="font-rubik">Descrição</h6>
                <hr>
